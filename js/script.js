...
function banTeam1() {
  if (count < 5) {
    wrapperChampions.addEventListener(
      "click",
      (e) => {
        if (countBanTeam1 < 5 && e.target && e.target.tagName == "BUTTON")  {
            for (let i = 0; i < wrapperChampions.childElementCount; i++) {
              if (wrapperChampions.children[i] == e.target) {
                wrapperBansTeamOne.children[countBanTeam1].classList.add(
                  wrapperChampions.children[i].classList[1]
                );
  ...
  if (count > 4 && count < 10) {
    wrapperChampions.addEventListener(
      "click",
      (e) => {
        if (countBanTeam2 < 5 && e.target && e.target.tagName == "BUTTON") {
            for (let i = 0; i < wrapperChampions.childElementCount; i++) {
              if (wrapperChampions.children[i] == e.target) {
                wrapperBansTeamTwo.children[countBanTeam2].classList.add(
                  wrapperChampions.children[i].classList[1]
                );
                wrapperChampions.children[i].classList.add("black-white");
                break;
  ...
  if (count == 10) {
    wrapperChampions.addEventListener(
      "click",
      (e) => {
        if (countPickTeam1 < 5 && e.target && e.target.tagName == "BUTTON") {
            for (let i = 0; i < wrapperChampions.childElementCount; i++) {
              if (wrapperChampions.children[i] == e.target) {
                wrapperPicksTeamOne.children[countPickTeam1].classList.add(
                  wrapperChampions.children[i].classList[1]
                );
                wrapperChampions.children[i].classList.add("black-white");
                break;
  ...
  if (count > 10 && count < 13) {
    wrapperChampions.addEventListener(
      "click",
      (e) => {
        if (countPickTeam2 < 5 && e.target && e.target.tagName == "BUTTON") {
            for (let i = 0; i < wrapperChampions.childElementCount; i++) {
              if (wrapperChampions.children[i] == e.target) {
                wrapperPicksTeamTwo.children[countPickTeam2].classList.add(
                  wrapperChampions.children[i].classList[1]
                );
                wrapperChampions.children[i].classList.add("black-white");
                break;
